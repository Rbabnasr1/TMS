...
<div class="containProm">
    <form action="AccountController"><br>
           <select name="dismiss" onchange="ShowData(this.value);" name="name" id="name" >
         <%
                    ...
                    String sql = "select FName , ID from acc_dep_sa,account where SA_ID="+session.getAttribute("SAID")+" and ID = Acc_ID and (type=0 or type=2)";
...
<!--<tr><td><br><input type="checkbox" name="skill" value="<%=MemberID%>" > <%=MemberName%></td></tr>-->
                ...
                <%
                    ...
                    con.close();
                        ...
                        <input type="submit" name="change"  value="Dismiss"/>
                        </div>
        <div id="Info" ></div>                  
        </form>
    </body>
